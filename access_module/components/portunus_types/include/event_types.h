...
typedef enum {
    ...
    /* Door state events: 0x04xx */
    EVENT_DOOR_OPENED   = 0x0400,     /**< Reed switch: door transitioned to open */
    EVENT_DOOR_CLOSED,                /**< Reed switch: door transitioned to closed */
...
/**
 * @brief Payload for EVENT_DOOR_OPENED / EVENT_DOOR_CLOSED.
 */
typedef struct {
